...
- เพิ่มหน้า System Check สำหรับตรวจความพร้อมของฐานข้อมูล ปีงบ รหัสผ่านกลาง โฟลเดอร์ และข้อมูลตั้งต้นก่อนใช้งานจริง
- เพิ่มเอกสาร `UAT_CHECKLIST.md` สำหรับไล่ทดสอบทุก role ก่อน sign-off

- เพิ่มหน้า audit log detail สำหรับเปิดดูรายละเอียดรายการ workflow history แบบอ่านง่ายและ raw JSON
- แยกหน้ารายการรายงานและรายละเอียดแบบอ่านอย่างเดียวสำหรับ DIRECTOR เพื่อลดการพึ่งหน้าฝั่ง admin
- เพิ่มเอกสาร `DEPLOYMENT_CHECKLIST.md` และ `SETUP_GUIDE.md` สำหรับเตรียมขึ้นใช้งานจริง

- เพิ่มช่องค้นหาเต็มข้อความใน Workflow History เพื่อค้นจาก entity id, action และรายละเอียดใน audit log ได้ในหน้าเดียว

- เพิ่มหน้า Workflow History สำหรับดู audit log ย้อนหลังของปีงบประมาณ, visibility และการรีเซ็ตเลขรัน
- เพิ่มตัวกรองตามผู้ดำเนินการและการ์ดสรุปจำนวนรายการบนหน้า Workflow History
- เพิ่ม Export CSV และลิงก์ drill-down จาก Workflow History กลับไปยังหน้าตั้งค่า workflow ที่เกี่ยวข้อง
...
- เตรียมต่อยอดหน้ารายละเอียด audit log เชิงลึก และการไฮไลต์คำค้นในประวัติ workflow

- เตรียมต่อยอดสรุปผลและค้นหาประวัติการตั้งค่า workflow จาก audit log ให้ใช้งานสะดวกขึ้น
- เตรียมต่อยอด export และ drill-down จาก Workflow History ไปยังรายการตั้งค่าที่เกี่ยวข้อง
- เตรียมต่อยอดหน้ารายละเอียด audit log เชิงลึก และการค้นหาแบบเต็มข้อความในประวัติ workflow
